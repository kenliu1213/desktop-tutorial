...
WebUI.sendKeys(findTestObject('ACX-Beta/Page_Ruckus Cloud/input_AP Name_apName'), 'Ken-R750')

WebUI.sendKeys(findTestObject('ACX-Beta/Page_Ruckus Cloud/input_Serial Number_apSerialNumber'), '201902000161')
...
WebUI.verifyElementPresent(findTestObject('ACX-Beta/Page_Ruckus Cloud/span_Ken-R750_in_AP'), 0)
